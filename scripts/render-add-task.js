  ...
  return /* html */ `<div class="addTaskForm">
                <div class="addTaskLeft addTaskWidth">
                    <div class="addTaskTitle formRow">
                        <label for="taskTitle" class="titleAddTask">Title<b class="require">*</b></label>
...
function renderAddTaskDescription() {
  return /* html */ `<div class="addTaskDescription formRow">
                <label class="lblDescription" for="taskDescriptionArea">Description<b class="require">*</b></label>
...
function renderAddTaskAssignetTo() {
  return /*html */ `<div class="addTaskAssigned formRow">
      <label class="lblAssigned" for="taskAssignedTo">Assigned to</label>
      ...
      <div class="checkboxName" id="checkBoxes" onclick="event.stopPropagation()">
        <div class="dropdownUsername" id="checkboxUsername">
          <input type="checkbox" id="user1" name="optionen" value="User 1"/>
          <label for="user1">User 1</label>
          <input type="checkbox" id="user2" name="optionen" value="User 2"/>
...
function renderAddTaskDueDate() {
  return /*html */ `<div class="addTaskLine"></div>
            ...
            <div class="addTaskDueDate formRow">
                <label for="taskDate" class="addTaskDate" >Due date<b class="require">*</b></label>
                <div class="taskCalender">
                    <input id="taskDate" class="addDate addTaskInput" type="date" required min="${setDate()}"/>
                </div>
            </div>`;
}
...
function renderAddTaskCategorie() {
  return /*html */ `<div class="addTaskCategory formRow">
                <label class="lblCategory" for="task_category">Category<b class="require">*</b></label>
...
function renderAddTaskSubtasks() {
  return /*html */ `<div class="addTaskSubtasks formRow">
                        <label class="lblSubtasks" for="taskSubtasks">Subtasks</label>
