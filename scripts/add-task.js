let BASE_URL =
  "https://join-2dab2-default-rtdb.europe-west1.firebasedatabase.app/";

let BASE_URL_addTask =
  "https://join-2dab2-default-rtdb.europe-west1.firebasedatabase.app/task";

let BASE_URL_Contacts =
  "https://join-2dab2-default-rtdb.europe-west1.firebasedatabase.app/contact";
...
async function createTask() {
  ...
  try {
    ...
    const response = await fetch(
      "https://join-2dab2-default-rtdb.europe-west1.firebasedatabase.app/task.json",
      {
        method: "POST",
        headers: {
