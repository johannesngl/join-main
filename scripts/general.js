...
function renderStates() {
  document.getElementById("sum-tasks-open").innerHTML =
    countStateOccurrences("to-do");
  document.getElementById("sum-tasks-done").innerHTML =
    countStateOccurrences("done");
  document.getElementById("sum-tasks-total").innerHTML = taskId.length;
  document.getElementById("sum-tasks-in-progress").innerHTML =
    countStateOccurrences("in-progress");
  document.getElementById("sum-tasks-await-feedback").innerHTML =
    countStateOccurrences("await-feedback");
  document.getElementById("sum-tasks-urgent").innerHTML = countUrgency();
  document.getElementById("greeting-depends-on-time").innerHTML =
    generateGreeting();
}
